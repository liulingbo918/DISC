...
Layer<Dtype>* GetLayer(const LayerParameter& param) {
	...
	case LayerParameter_LayerType_CONTOUR_GUIDED_EUCLIDEAN_LOSS:
		return new ContourGuidedEuclideanLossLayer<Dtype>(param);
	...
	case LayerParameter_LayerType_DECONVOLUTION_WITH_DF:
		return new DeconvolutionWithDFLayer<Dtype>(param);
	...
	case LayerParameter_LayerType_MULTI_HINGE_LOSS:
		return new MultiHingeLossLayer<Dtype>(param);

	case LayerParameter_LayerType_MULTI_HINGE_LOSS_NORM:
		return new MultiHingeLossNormLayer<Dtype>(param);

	case LayerParameter_LayerType_HINGE_ACCURACY:
		return new HingeAccuracyLayer<Dtype>(param);

	case LayerParameter_LayerType_HINGE_NORM_ACCURACY:
		return new HingeNormAccuracyLayer<Dtype>(param);

	case LayerParameter_LayerType_INTRA_SMOOTH:
		return new IntraSmoothLayer<Dtype>(param);

	case LayerParameter_LayerType_INTRA_SMOOTHING:
		return new IntraSmoothingLayer<Dtype>(param);

	case LayerParameter_LayerType_EXTRA_VOTE:
		return new ExtraVoteLayer<Dtype>(param);

	case LayerParameter_LayerType_IMAGE_DATA_SG:
		return new ImageDataSGLayer<Dtype>(param);

	case LayerParameter_LayerType_IMAGE_DATA_SL:
		return new ImageDataSLLayer<Dtype>(param);

	case LayerParameter_LayerType_IMAGE_DATA_SEG:
		return new ImageDataSEGLayer<Dtype>(param);

	case LayerParameter_LayerType_IMAGE_DATA_SEG1:
		return new ImageDataSEG1Layer<Dtype>(param);

	case LayerParameter_LayerType_IMAGE_DATA_JOINT:
		return new ImageDataJointLayer<Dtype>(param);

	case LayerParameter_LayerType_ANTI_SUPER:
		return new AntiSuperpixelLayer<Dtype>(param);

	case LayerParameter_LayerType_IMAGE_DATA_SM:
		return new ImageDataSMLayer<Dtype>(param);

	case LayerParameter_LayerType_SVM_NORM:
		return new SVMNormLayer<Dtype>(param);

	case LayerParameter_LayerType_EXTRA_VOTING:
		return new ExtraVotingLayer<Dtype>(param);
	...
	case LayerParameter_LayerType_WEIGHT_EUCLIDEAN_LOSS:
		return new WeightEuclideanLossLayer<Dtype>(param);
