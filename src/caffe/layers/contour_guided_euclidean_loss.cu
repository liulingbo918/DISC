...
void ContourGuidedEuclideanLossLayer<Dtype>::Forward_gpu(
...
//	}
	...
	for (int i = 0; i < bottom[0]->num(); i++) {
		...
		caffe_copy(height_mul_width,
				label_data + bottom[1]->offset(i) + 2 * height_mul_width, // move to the last channel
...
template<typename Dtype>
void ContourGuidedEuclideanLossLayer<Dtype>::Backward_gpu(
