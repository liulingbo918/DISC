...
ImageDataSEG1Layer<Dtype>::~ImageDataSEG1Layer<Dtype>() {
	this->JoinPrefetchThread();
}

template<typename Dtype>
void ImageDataSEG1Layer<Dtype>::DataLayerSetUp(
...
template<typename Dtype>
void ImageDataSEG1Layer<Dtype>::ShuffleImages() {
...
template<typename Dtype>
void ImageDataSEG1Layer<Dtype>::InternalThreadEntry() {
	Datum datum;
...
INSTANTIATE_CLASS(ImageDataSEG1Layer);
