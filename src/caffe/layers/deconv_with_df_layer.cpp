...
void DeconvolutionWithDFLayer<Dtype>::compute_output_shape() {
...
template<typename Dtype>
void DeconvolutionWithDFLayer<Dtype>::Forward_cpu(const vector<Blob<Dtype>*>& bottom,
...
template<typename Dtype>
void DeconvolutionWithDFLayer<Dtype>::Backward_cpu(const vector<Blob<Dtype>*>& top,
...
#ifdef CPU_ONLY
STUB_GPU(DeconvolutionWithDFLayer);
#endif

INSTANTIATE_CLASS(DeconvolutionWithDFLayer);
//REGISTER_LAYER_CLASS(DECONVOLUTION, DeconvolutionWithDFLayer);
}// namespace caffe
