...
bool ReadLrAndGtToDatum(const string& filename, const int height, const int width,
		const bool is_color, Datum* datum);

bool ReadLrAndGtToDatum_Y_Only(const string& filename, const int height, const int width,
		const bool is_color, Datum* datum);

bool ReadImageToDatumSG(const string& filename, const string label,
    const int height, const int width, const bool is_color, Datum* datum);

inline bool ReadImageToDatumSG(const string& filename, const string label,
    const int height, const int width, Datum* datum) {
  return ReadImageToDatumSG(filename, label, height, width, true, datum);
}

bool ReadImageToDatumSEG(const string& filename, const string label,
    const int height, const int width, const bool is_color, Datum* datum);

inline bool ReadImageToDatumSEG(const string& filename, const string label,
    const int height, const int width, Datum* datum) {
  return ReadImageToDatumSEG(filename, label, height, width, true, datum);
}
...
inline bool ReadImageToDatumJ(const string& filename, const string label,
    const int height, const int width, Datum* datum, vector<float>& nei_weights) {
  return ReadImageToDatumJ(filename, label, height, width, true, datum, nei_weights);
}

bool ReadImageToDatumSM(const string& filename, const string label,
    const int height, const int width, const bool is_color, Datum* datum);

inline bool ReadImageToDatumSM(const string& filename, const string label,
    const int height, const int width, Datum* datum) {
  return ReadImageToDatumSM(filename, label, height, width, true, datum);
}

bool ReadImageToDatumSL(const string& filename, const string label,
    const int height, const int width, const bool is_color, Datum* datum);

inline bool ReadImageToDatumSL(const string& filename, const string label,
    const int height, const int width, Datum* datum) {
  return ReadImageToDatumSL(filename, label, height, width, true, datum);
}
