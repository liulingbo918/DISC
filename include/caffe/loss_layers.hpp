...
template <typename Dtype>
class HingeAccuracyLayer : public Layer<Dtype> {
 public:
  /**
   * @param param provides AccuracyParameter accuracy_param,
   *     with AccuracyLayer options:
   ...
   *     correct if the correct label is among the top 5 predicted labels.
   */
  explicit HingeAccuracyLayer(const LayerParameter& param)
      : Layer<Dtype>(param) {}
  virtual void LayerSetUp(const vector<Blob<Dtype>*>& bottom,
      vector<Blob<Dtype>*>* top);
  virtual void Reshape(const vector<Blob<Dtype>*>& bottom,
  ...
  virtual inline LayerParameter_LayerType type() const {
    return LayerParameter_LayerType_HINGE_ACCURACY;
  }
...
template <typename Dtype>
class HingeNormAccuracyLayer : public Layer<Dtype> {
 public:
  /**
   * @param param provides AccuracyParameter accuracy_param,
   *     with AccuracyLayer options:
   ...
   *     correct if the correct label is among the top 5 predicted labels.
   */
  explicit HingeNormAccuracyLayer(const LayerParameter& param)
      : Layer<Dtype>(param) {}
  virtual void LayerSetUp(const vector<Blob<Dtype>*>& bottom,
      vector<Blob<Dtype>*>* top);
  virtual void Reshape(const vector<Blob<Dtype>*>& bottom,
  ...
  virtual inline LayerParameter_LayerType type() const {
    return LayerParameter_LayerType_HINGE_NORM_ACCURACY;
  }
...
class WeightEuclideanLossLayer : public LossLayer<Dtype> {
 public:
  ...
  virtual inline LayerParameter_LayerType type() const {
    return LayerParameter_LayerType_WEIGHT_EUCLIDEAN_LOSS;
  }
...
template <typename Dtype>
class ContourGuidedEuclideanLossLayer : public LossLayer<Dtype> {
 public:
  explicit ContourGuidedEuclideanLossLayer(const LayerParameter& param)
      : LossLayer<Dtype>(param), diff_() {}
  virtual void Reshape(const vector<Blob<Dtype>*>& bottom,
      vector<Blob<Dtype>*>* top);
...
class MultiHingeLossLayer : public LossLayer<Dtype> {
 public:
  ...
  virtual inline LayerParameter_LayerType type() const {
    return LayerParameter_LayerType_MULTI_HINGE_LOSS;
  }
...
template <typename Dtype>
class MultiHingeLossNormLayer : public LossLayer<Dtype> {
 public:
  explicit MultiHingeLossNormLayer(const LayerParameter& param)
      : LossLayer<Dtype>(param) {}

  virtual inline LayerParameter_LayerType type() const {
    return LayerParameter_LayerType_MULTI_HINGE_LOSS_NORM;
  }
